            ...
            <WarningPanel
              ...
              message={
                <>
                  ...
                  through the&nbsp;
                  <Link
                    href="https://github.com/BESTSELLER/backstage/milestones"
          ...
          <Grid item xs={12} md={6}>
            <InfoCard title="What Now?">
              ...
              <Typography variant="body1" paragraph>
                ...
                <Link
                  href="https://github.com/BESTSELLER/backstage/blob/master/docs/plugins/create-a-plugin.md"
                  rel="noopener noreferrer"
                >
                  creating a plugin
                </Link>{' '}
                ...
                in the directory{' '}
                <Link
                  href="https://github.com/BESTSELLER/backstage/tree/master/plugins"
                  rel="noopener noreferrer"
                >
                  <code>plugins/</code>
                </Link>
