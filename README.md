...
[![Main CI Build](https://github.com/BESTSELLER/backstage/workflows/Main%20Master%20Build/badge.svg)](https://github.com/BESTSELLER/backstage/actions?query=workflow%3A%22Main+Master+Build%22)
[![Discord](https://img.shields.io/discord/687207715902193673)](https://discord.gg/EBHEGzX)
![Code style](https://img.shields.io/badge/code_style-prettier-ff69b4.svg)
[![Codecov](https://img.shields.io/codecov/c/github/backstage/backstage)](https://codecov.io/gh/backstage/backstage)
[![](https://img.shields.io/npm/v/@backstage/core?label=Version)](https://github.com/BESTSELLER/backstage/releases)
...
- Plus, a growing ecosystem of [open source plugins](https://github.com/BESTSELLER/backstage/tree/master/plugins) that further expand Backstage’s customizability and functionality
...
- [Good First Issues](https://github.com/BESTSELLER/backstage/contribute) - Start here if you want to contribute
- [RFCs](https://github.com/BESTSELLER/backstage/labels/rfc) - Help shape the technical direction
