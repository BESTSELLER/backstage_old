        ...
        <div className="PluginCard" id="add-plugin-card">
          ...
          <Container className="PluginCardFooter">
            <p>
              ...
              <a href="https://github.com/BESTSELLER/backstage/issues?q=is%3Aissue+is%3Aopen+label%3Aplugin+sort%3Areactions-%2B1-desc">
                in progress
              </a>{' '}
              and 👍. Missing a plugin for your favorite tool? Please{' '}
              <a href="https://github.com/BESTSELLER/backstage/issues/new?labels=plugin&template=plugin_template.md&title=%5BPlugin%5D+THE+PLUGIN+NAME">
                suggest
              </a>{' '}
              a new one.
            </p>
