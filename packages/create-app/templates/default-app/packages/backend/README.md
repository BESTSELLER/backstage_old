...
Read more about the
[auth-backend](https://github.com/BESTSELLER/backstage/blob/master/plugins/auth-backend/README.md)
and
[how to add a new provider](https://github.com/BESTSELLER/backstage/blob/master/docs/auth/add-auth-provider.md)
